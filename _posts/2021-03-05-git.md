...
<img src = "../../assets/images/git/show_diff.png" style = "height: 200px; width : 900px">
<span style = "font-size : 11px">github에서는 이전 커밋과의 차이점을 위와 같이 보여준다.</span>  

<img src = "../../assets/images/git/git.png">
